...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String row_lokasipengguna = "TempatLahir";
    public static final String row_waktuvaksin = "Tanggal";
    ...
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE " + table_name + "(" + row_id + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + row_nik + " TEXT, " + row_nohp + " TEXT , " + row_nama + " TEXT, " + row_jk + " TEXT, "
                + row_lokasipengguna + " TEXT, " + row_waktuvaksin + " TEXT, " + row_alamat + " TEXT)";
        db.execSQL(query);
    }
